...
var API_KEY = "live_79QknEfNbS4W1lE2rHXP5O16POeJjQTVmV0IuLoj5XUJyGhXL9aDVT3YPfTwPJQy";
...
var carouselDiv = document.getElementById("carouselExampleControls");
var carouselInner = document.getElementById("carouselInner");
function handleBreedSelect(_x) {
  return _handleBreedSelect.apply(this, arguments);
}
function _handleBreedSelect() {
  _handleBreedSelect = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(e) {
    var value, breedURL, res, data;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          value = e.target.value;
          breedURL = "https://api.thecatapi.com/v1/images/search?limit=10&breed_ids=".concat(value, "&api_key=").concat(API_KEY);
          console.log(value);
          _context2.prev = 3;
          Carousel.clear();
          _context2.next = 7;
        ...
        case 10:
          ...
          data.forEach(function (el) {
            var carouselItem = Carousel.createCarouselItem(el.url, "".concat(value, "'s image"), el.id);
...
function createInfo(data) {
  ...
  document.getElementById("infoDump").appendChild(name);
  var description = document.createElement("p");
  description.textContent = data[0].breeds[0].description;
  document.getElementById("infoDump").appendChild(description);
  var life_span = document.createElement("p");
  life_span.textContent = "Life span: ".concat(data[0].breeds[0].life_span);
  document.getElementById("infoDump").appendChild(life_span);
}
function clearInfo() {
  document.getElementById("infoDump").textContent = "";
}
/**
 ...
 */
// axios.defaults.baseURL = "https://api.thecatapi.com/v1"; // Set your base URL

// // Set default headers, including your API key
// axios.defaults.headers.common["x-api-key"] =
//   "live_79QknEfNbS4W1lE2rHXP5O16POeJjQTVmV0IuLoj5XUJyGhXL9aDVT3YPfTwPJQy"; //

// async function initialLoad() {
//   try {
//     let response = await axios.get("/breeds"); //endpoint string
...
//   const breedURL = `/images/search?limit=10&breed_ids=${value}`;
//   console.log(value);
//   try {
//     Carousel.clear();
...
//# sourceMappingURL=/308A.4catAPI_lab.e31bb0bc.js.map